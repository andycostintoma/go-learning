...
Each 01_goroutine writes 10 numbers to its own channel.
Use a +for-select+ loop to read from both channels, printing out the number and the 01_goroutine that wrote the value.
